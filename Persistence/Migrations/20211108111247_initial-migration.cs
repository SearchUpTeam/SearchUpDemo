    ...
    public partial class initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RelatedEventsId = table.Column<int>(type: "int", nullable: false),
                    TopicsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventInterestTag", x => new { x.RelatedEventsId, x.TopicsId });
                    table.ForeignKey(
                        name: "FK_EventInterestTag_Events_RelatedEventsId",
                        column: x => x.RelatedEventsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventInterestTag_InterestTags_TopicsId",
                        column: x => x.TopicsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterestTagUser", x => new { x.InteresteddUsersId, x.InterestsId });
                    table.ForeignKey(
                        name: "FK_InterestTagUser_AspNetUsers_InteresteddUsersId",
                        column: x => x.InteresteddUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterestTagUser_InterestTags_InterestsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventInterestTag_TopicsId",
                table: "EventInterestTag",
                column: "TopicsId");
